...
class Kumoa:
    def __init__(self, sovelluslogiikka, lue_syote, hae_edellinen_komento):
        self._sovelluslogiikka = sovelluslogiikka
        self._lue_syote = lue_syote
        self._hae_edellinen_komento = hae_edellinen_komento

    def suorita(self):
        edellinen = self._hae_edellinen_komento()
...
class Kayttoliittyma:
    def __init__(self, sovelluslogiikka, root):
        ...
        self._komennot = {
            ...
            Komento.KUMOA: Kumoa(sovelluslogiikka, self._lue_syote, self._hae_edellinen_komento)
        }
